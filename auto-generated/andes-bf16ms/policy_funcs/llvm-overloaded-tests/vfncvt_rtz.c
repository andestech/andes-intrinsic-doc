...
vint8mf8_t test_vfncvt_rtz_x_f_w_i8mf8_tu(vint8mf8_t vd, vbfloat16mf4_t vs2,
                                          size_t vl) {
  return __riscv_vfncvt_rtz_x_tu(vd, vs2, vl);
}

vint8mf4_t test_vfncvt_rtz_x_f_w_i8mf4_tu(vint8mf4_t vd, vbfloat16mf2_t vs2,
                                          size_t vl) {
  return __riscv_vfncvt_rtz_x_tu(vd, vs2, vl);
}

vint8mf2_t test_vfncvt_rtz_x_f_w_i8mf2_tu(vint8mf2_t vd, vbfloat16m1_t vs2,
                                          size_t vl) {
  return __riscv_vfncvt_rtz_x_tu(vd, vs2, vl);
}

vint8m1_t test_vfncvt_rtz_x_f_w_i8m1_tu(vint8m1_t vd, vbfloat16m2_t vs2,
                                        size_t vl) {
  return __riscv_vfncvt_rtz_x_tu(vd, vs2, vl);
}

vint8m2_t test_vfncvt_rtz_x_f_w_i8m2_tu(vint8m2_t vd, vbfloat16m4_t vs2,
                                        size_t vl) {
  return __riscv_vfncvt_rtz_x_tu(vd, vs2, vl);
}

vint8m4_t test_vfncvt_rtz_x_f_w_i8m4_tu(vint8m4_t vd, vbfloat16m8_t vs2,
                                        size_t vl) {
  return __riscv_vfncvt_rtz_x_tu(vd, vs2, vl);
}

vuint8mf8_t test_vfncvt_rtz_xu_f_w_u8mf8_tu(vuint8mf8_t vd, vbfloat16mf4_t vs2,
                                            size_t vl) {
  return __riscv_vfncvt_rtz_xu_tu(vd, vs2, vl);
}

vuint8mf4_t test_vfncvt_rtz_xu_f_w_u8mf4_tu(vuint8mf4_t vd, vbfloat16mf2_t vs2,
                                            size_t vl) {
  return __riscv_vfncvt_rtz_xu_tu(vd, vs2, vl);
}

vuint8mf2_t test_vfncvt_rtz_xu_f_w_u8mf2_tu(vuint8mf2_t vd, vbfloat16m1_t vs2,
                                            size_t vl) {
  return __riscv_vfncvt_rtz_xu_tu(vd, vs2, vl);
}

vuint8m1_t test_vfncvt_rtz_xu_f_w_u8m1_tu(vuint8m1_t vd, vbfloat16m2_t vs2,
                                          size_t vl) {
  return __riscv_vfncvt_rtz_xu_tu(vd, vs2, vl);
}

vuint8m2_t test_vfncvt_rtz_xu_f_w_u8m2_tu(vuint8m2_t vd, vbfloat16m4_t vs2,
                                          size_t vl) {
  return __riscv_vfncvt_rtz_xu_tu(vd, vs2, vl);
}

vuint8m4_t test_vfncvt_rtz_xu_f_w_u8m4_tu(vuint8m4_t vd, vbfloat16m8_t vs2,
                                          size_t vl) {
  return __riscv_vfncvt_rtz_xu_tu(vd, vs2, vl);
}
