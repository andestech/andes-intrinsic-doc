...
vbfloat16m1_t test_vfredusum_vs_bf16mf4_bf16m1_rm_m(vbool64_t vm,
                                                    ...
                                                    vbfloat16m1_t vs1,
                                                    size_t vl) {
  return __riscv_vfredusum_vs_bf16mf4_bf16m1_rm_m(vm, vs2, vs1, __RISCV_FRM_RNE,
                                                  vl);
}
...
vbfloat16m1_t test_vfredusum_vs_bf16mf2_bf16m1_rm_m(vbool32_t vm,
                                                    ...
                                                    vbfloat16m1_t vs1,
                                                    size_t vl) {
  return __riscv_vfredusum_vs_bf16mf2_bf16m1_rm_m(vm, vs2, vs1, __RISCV_FRM_RNE,
                                                  vl);
}
...
vbfloat16m1_t test_vfredusum_vs_bf16m1_bf16m1_rm_m(vbool16_t vm,
                                                   ...
                                                   vbfloat16m1_t vs1,
                                                   size_t vl) {
  return __riscv_vfredusum_vs_bf16m1_bf16m1_rm_m(vm, vs2, vs1, __RISCV_FRM_RNE,
                                                 vl);
}
...
vbfloat16m1_t test_vfredusum_vs_bf16m2_bf16m1_rm_m(vbool8_t vm,
                                                   ...
                                                   vbfloat16m1_t vs1,
                                                   size_t vl) {
  return __riscv_vfredusum_vs_bf16m2_bf16m1_rm_m(vm, vs2, vs1, __RISCV_FRM_RNE,
                                                 vl);
}
...
vbfloat16m1_t test_vfredusum_vs_bf16m4_bf16m1_rm_m(vbool4_t vm,
                                                   ...
                                                   vbfloat16m1_t vs1,
                                                   size_t vl) {
  return __riscv_vfredusum_vs_bf16m4_bf16m1_rm_m(vm, vs2, vs1, __RISCV_FRM_RNE,
                                                 vl);
}
...
vbfloat16m1_t test_vfredusum_vs_bf16m8_bf16m1_rm_m(vbool2_t vm,
                                                   ...
                                                   vbfloat16m1_t vs1,
                                                   size_t vl) {
  return __riscv_vfredusum_vs_bf16m8_bf16m1_rm_m(vm, vs2, vs1, __RISCV_FRM_RNE,
                                                 vl);
}
