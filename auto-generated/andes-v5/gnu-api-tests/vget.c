...
vbfloat16mf4_t test_vget_v_bf16mf4x2_bf16mf4(vbfloat16mf4x2_t src, size_t index) {
  return __riscv_vget_v_bf16mf4x2_bf16mf4(src, 0);
}

vbfloat16mf4_t test_vget_v_bf16mf4x3_bf16mf4(vbfloat16mf4x3_t src, size_t index) {
  return __riscv_vget_v_bf16mf4x3_bf16mf4(src, 0);
}

vbfloat16mf4_t test_vget_v_bf16mf4x4_bf16mf4(vbfloat16mf4x4_t src, size_t index) {
  return __riscv_vget_v_bf16mf4x4_bf16mf4(src, 0);
}

vbfloat16mf4_t test_vget_v_bf16mf4x5_bf16mf4(vbfloat16mf4x5_t src, size_t index) {
  return __riscv_vget_v_bf16mf4x5_bf16mf4(src, 0);
}

vbfloat16mf4_t test_vget_v_bf16mf4x6_bf16mf4(vbfloat16mf4x6_t src, size_t index) {
  return __riscv_vget_v_bf16mf4x6_bf16mf4(src, 0);
}

vbfloat16mf4_t test_vget_v_bf16mf4x7_bf16mf4(vbfloat16mf4x7_t src, size_t index) {
  return __riscv_vget_v_bf16mf4x7_bf16mf4(src, 0);
}

vbfloat16mf4_t test_vget_v_bf16mf4x8_bf16mf4(vbfloat16mf4x8_t src, size_t index) {
  return __riscv_vget_v_bf16mf4x8_bf16mf4(src, 0);
}

vbfloat16mf2_t test_vget_v_bf16mf2x2_bf16mf2(vbfloat16mf2x2_t src, size_t index) {
  return __riscv_vget_v_bf16mf2x2_bf16mf2(src, 0);
}

vbfloat16mf2_t test_vget_v_bf16mf2x3_bf16mf2(vbfloat16mf2x3_t src, size_t index) {
  return __riscv_vget_v_bf16mf2x3_bf16mf2(src, 0);
}

vbfloat16mf2_t test_vget_v_bf16mf2x4_bf16mf2(vbfloat16mf2x4_t src, size_t index) {
  return __riscv_vget_v_bf16mf2x4_bf16mf2(src, 0);
}

vbfloat16mf2_t test_vget_v_bf16mf2x5_bf16mf2(vbfloat16mf2x5_t src, size_t index) {
  return __riscv_vget_v_bf16mf2x5_bf16mf2(src, 0);
}

vbfloat16mf2_t test_vget_v_bf16mf2x6_bf16mf2(vbfloat16mf2x6_t src, size_t index) {
  return __riscv_vget_v_bf16mf2x6_bf16mf2(src, 0);
}

vbfloat16mf2_t test_vget_v_bf16mf2x7_bf16mf2(vbfloat16mf2x7_t src, size_t index) {
  return __riscv_vget_v_bf16mf2x7_bf16mf2(src, 0);
}

vbfloat16mf2_t test_vget_v_bf16mf2x8_bf16mf2(vbfloat16mf2x8_t src, size_t index) {
