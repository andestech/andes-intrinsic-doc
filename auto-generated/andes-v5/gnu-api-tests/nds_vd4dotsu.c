...
vint32mf2_t test_nds_vd4dotsu_vv_i32mf2_m(vbool64_t vm, vint32mf2_t vd, vint8mf2_t vs1, vuint8mf2_t vs2, size_t vl) {
  return __riscv_nds_vd4dotsu_vv_i32mf2_m(vm, vd, vs1, vs2, vl);
}

vint32m1_t test_nds_vd4dotsu_vv_i32m1_m(vbool32_t vm, vint32m1_t vd, vint8m1_t vs1, vuint8m1_t vs2, size_t vl) {
  return __riscv_nds_vd4dotsu_vv_i32m1_m(vm, vd, vs1, vs2, vl);
}

vint32m2_t test_nds_vd4dotsu_vv_i32m2_m(vbool16_t vm, vint32m2_t vd, vint8m2_t vs1, vuint8m2_t vs2, size_t vl) {
  return __riscv_nds_vd4dotsu_vv_i32m2_m(vm, vd, vs1, vs2, vl);
}

vint32m4_t test_nds_vd4dotsu_vv_i32m4_m(vbool8_t vm, vint32m4_t vd, vint8m4_t vs1, vuint8m4_t vs2, size_t vl) {
  return __riscv_nds_vd4dotsu_vv_i32m4_m(vm, vd, vs1, vs2, vl);
}

vint32m8_t test_nds_vd4dotsu_vv_i32m8_m(vbool4_t vm, vint32m8_t vd, vint8m8_t vs1, vuint8m8_t vs2, size_t vl) {
  return __riscv_nds_vd4dotsu_vv_i32m8_m(vm, vd, vs1, vs2, vl);
}

vint64m1_t test_nds_vd4dotsu_vv_i64m1_m(vbool64_t vm, vint64m1_t vd, vint16m1_t vs1, vuint16m1_t vs2, size_t vl) {
  return __riscv_nds_vd4dotsu_vv_i64m1_m(vm, vd, vs1, vs2, vl);
}

vint64m2_t test_nds_vd4dotsu_vv_i64m2_m(vbool32_t vm, vint64m2_t vd, vint16m2_t vs1, vuint16m2_t vs2, size_t vl) {
  return __riscv_nds_vd4dotsu_vv_i64m2_m(vm, vd, vs1, vs2, vl);
}

vint64m4_t test_nds_vd4dotsu_vv_i64m4_m(vbool16_t vm, vint64m4_t vd, vint16m4_t vs1, vuint16m4_t vs2, size_t vl) {
  return __riscv_nds_vd4dotsu_vv_i64m4_m(vm, vd, vs1, vs2, vl);
}

vint64m8_t test_nds_vd4dotsu_vv_i64m8_m(vbool8_t vm, vint64m8_t vd, vint16m8_t vs1, vuint16m8_t vs2, size_t vl) {
