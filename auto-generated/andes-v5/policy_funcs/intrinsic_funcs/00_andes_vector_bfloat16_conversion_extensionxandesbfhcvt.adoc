...
=== Andes Vector BFLOAT16 Conversion Extension(XAndesBFHCvt)

[[policy-variant-bf16-vector-unit-stride-load]]
==== Vector Unit-Stride Load Intrinsics(XAndesBFHCvt)
...
==== Vector Unit-Stride Store Intrinsics(XAndesBFHCvt)
Intrinsics here don't have a policy variant.

[[policy-variant-vector-strided-load]]
==== Vector Strided Load Intrinsics(XAndesBFHCvt)
...
==== Vector Strided Store Intrinsics(XAndesBFHCvt)
Intrinsics here don't have a policy variant.

[[policy-variant-vector-indexed-load]]
==== Vector Indexed Load Intrinsics(XAndesBFHCvt)
...
==== Vector Indexed Store Intrinsics(XAndesBFHCvt)
Intrinsics here don't have a policy variant.

[[policy-variant-unit-stride-fault-only-first-loads]]
==== Unit-stride Fault-Only-First Loads Intrinsics(XAndesBFHCvt)
...
==== Vector Unit-Stride Segment Load Intrinsics(XAndesBFHCvt)
...
==== Vector Unit-Stride Segment Store Intrinsics(XAndesBFHCvt)
Intrinsics here don't have a policy variant.

[[policy-variant-vector-strided-segment-load]]
==== Vector Strided Segment Load Intrinsics(XAndesBFHCvt)
...
==== Vector Strided Segment Store Intrinsics(XAndesBFHCvt)
Intrinsics here don't have a policy variant.

[[policy-variant-vector-indexed-segment-load]]
==== Vector Indexed Segment Load Intrinsics(XAndesBFHCvt)
...
==== Vector Indexed Segment Store Intrinsics(XAndesBFHCvt)
Intrinsics here don't have a policy variant.

[[policy-variant-bf16-vector-narrow-convert]]
==== Vector Narrowing Convert Intrinsics(XAndesBFHCvt)
...
==== Vector Widening Convert Intrinsics(XAndesBFHCvt)
...
==== Reinterpret Cast Conversion Intrinsics(XAndesBFHCvt)
Intrinsics here don't have a policy variant.

[[policy-variant-vector-lmul-extensionn]]
==== Vector LMUL Extension Intrinsics(XAndesBFHCvt)
Intrinsics here don't have a policy variant.

[[policy-variant-vector-lmul-truncation]]
==== Vector LMUL Truncation Intrinsics(XAndesBFHCvt)
Intrinsics here don't have a policy variant.

[[policy-variant-vector-initialization]]
==== Vector Initialization Intrinsics(XAndesBFHCvt)
Intrinsics here don't have a policy variant.

[[policy-variant-vector-insertion]]
==== Vector Insertion Intrinsics(XAndesBFHCvt)
Intrinsics here don't have a policy variant.

[[policy-variant-vector-extraction]]
==== Vector Extraction Intrinsics(XAndesBFHCvt)
Intrinsics here don't have a policy variant.

[[policy-variant-vector-creation]]
==== Vector Creation Intrinsics(XAndesBFHCvt)
Intrinsics here don't have a policy variant.
