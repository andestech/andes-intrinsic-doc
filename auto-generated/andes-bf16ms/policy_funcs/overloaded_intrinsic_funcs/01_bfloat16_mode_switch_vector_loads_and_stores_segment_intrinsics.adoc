...
=== BFloat16 Mode Switch Vector Loads and Stores Segment Intrinsics

[[policy-variant-overloadedbf16-mode-switch-vector-unit-stride-segment-load]]
==== BFloat16 Mode Switch Vector Unit-Stride Segment Load Intrinsics
...
==== BFloat16 Mode Switch Vector Unit-Stride Segment Store Intrinsics
Intrinsics here don't have a policy variant.

[[policy-variant-overloadedbf16-mode-switch-vector-strided-segment-load]]
==== BFloat16 Mode Switch Vector Strided Segment Load Intrinsics
...
==== BFloat16 Mode Switch Vector Strided Segment Store Intrinsics
Intrinsics here don't have a policy variant.

[[policy-variant-overloadedbf16-mode-switch-vector-indexed-segment-load]]
==== BFloat16 Mode Switch Vector Indexed Segment Load Intrinsics
...
==== BFloat16 Mode Switch Vector Indexed Segment Store Intrinsics
Intrinsics here don't have a policy variant.
