...
vint32mf2_t test_vfwcvt_rtz_x_f_v_i32mf2_tu(vint32mf2_t vd, vbfloat16mf4_t vs2,
                                            size_t vl) {
  return __riscv_vfwcvt_rtz_x_tu(vd, vs2, vl);
}

vint32m1_t test_vfwcvt_rtz_x_f_v_i32m1_tu(vint32m1_t vd, vbfloat16mf2_t vs2,
                                          size_t vl) {
  return __riscv_vfwcvt_rtz_x_tu(vd, vs2, vl);
}

vint32m2_t test_vfwcvt_rtz_x_f_v_i32m2_tu(vint32m2_t vd, vbfloat16m1_t vs2,
                                          size_t vl) {
  return __riscv_vfwcvt_rtz_x_tu(vd, vs2, vl);
}

vint32m4_t test_vfwcvt_rtz_x_f_v_i32m4_tu(vint32m4_t vd, vbfloat16m2_t vs2,
                                          size_t vl) {
  return __riscv_vfwcvt_rtz_x_tu(vd, vs2, vl);
}

vint32m8_t test_vfwcvt_rtz_x_f_v_i32m8_tu(vint32m8_t vd, vbfloat16m4_t vs2,
                                          size_t vl) {
  return __riscv_vfwcvt_rtz_x_tu(vd, vs2, vl);
}
...
vuint32m1_t test_vfwcvt_rtz_xu_f_v_u32m1_tu(vuint32m1_t vd, vbfloat16mf2_t vs2,
                                            size_t vl) {
  return __riscv_vfwcvt_rtz_xu_tu(vd, vs2, vl);
}

vuint32m2_t test_vfwcvt_rtz_xu_f_v_u32m2_tu(vuint32m2_t vd, vbfloat16m1_t vs2,
                                            size_t vl) {
  return __riscv_vfwcvt_rtz_xu_tu(vd, vs2, vl);
}

vuint32m4_t test_vfwcvt_rtz_xu_f_v_u32m4_tu(vuint32m4_t vd, vbfloat16m2_t vs2,
                                            size_t vl) {
  return __riscv_vfwcvt_rtz_xu_tu(vd, vs2, vl);
}

vuint32m8_t test_vfwcvt_rtz_xu_f_v_u32m8_tu(vuint32m8_t vd, vbfloat16m4_t vs2,
                                            size_t vl) {
  return __riscv_vfwcvt_rtz_xu_tu(vd, vs2, vl);
}
