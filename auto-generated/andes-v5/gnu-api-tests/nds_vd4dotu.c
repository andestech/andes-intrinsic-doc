...
vuint32mf2_t test_nds_vd4dotu_vv_u32mf2_m(vbool64_t vm, vuint32mf2_t vd, vuint8mf2_t vs1, vuint8mf2_t vs2, size_t vl) {
  return __riscv_nds_vd4dotu_vv_u32mf2_m(vm, vd, vs1, vs2, vl);
}

vuint32m1_t test_nds_vd4dotu_vv_u32m1_m(vbool32_t vm, vuint32m1_t vd, vuint8m1_t vs1, vuint8m1_t vs2, size_t vl) {
  return __riscv_nds_vd4dotu_vv_u32m1_m(vm, vd, vs1, vs2, vl);
}

vuint32m2_t test_nds_vd4dotu_vv_u32m2_m(vbool16_t vm, vuint32m2_t vd, vuint8m2_t vs1, vuint8m2_t vs2, size_t vl) {
  return __riscv_nds_vd4dotu_vv_u32m2_m(vm, vd, vs1, vs2, vl);
}

vuint32m4_t test_nds_vd4dotu_vv_u32m4_m(vbool8_t vm, vuint32m4_t vd, vuint8m4_t vs1, vuint8m4_t vs2, size_t vl) {
  return __riscv_nds_vd4dotu_vv_u32m4_m(vm, vd, vs1, vs2, vl);
}

vuint32m8_t test_nds_vd4dotu_vv_u32m8_m(vbool4_t vm, vuint32m8_t vd, vuint8m8_t vs1, vuint8m8_t vs2, size_t vl) {
  return __riscv_nds_vd4dotu_vv_u32m8_m(vm, vd, vs1, vs2, vl);
}

vuint64m1_t test_nds_vd4dotu_vv_u64m1_m(vbool64_t vm, vuint64m1_t vd, vuint16m1_t vs1, vuint16m1_t vs2, size_t vl) {
  return __riscv_nds_vd4dotu_vv_u64m1_m(vm, vd, vs1, vs2, vl);
}

vuint64m2_t test_nds_vd4dotu_vv_u64m2_m(vbool32_t vm, vuint64m2_t vd, vuint16m2_t vs1, vuint16m2_t vs2, size_t vl) {
  return __riscv_nds_vd4dotu_vv_u64m2_m(vm, vd, vs1, vs2, vl);
}

vuint64m4_t test_nds_vd4dotu_vv_u64m4_m(vbool16_t vm, vuint64m4_t vd, vuint16m4_t vs1, vuint16m4_t vs2, size_t vl) {
  return __riscv_nds_vd4dotu_vv_u64m4_m(vm, vd, vs1, vs2, vl);
}

vuint64m8_t test_nds_vd4dotu_vv_u64m8_m(vbool8_t vm, vuint64m8_t vd, vuint16m8_t vs1, vuint16m8_t vs2, size_t vl) {
